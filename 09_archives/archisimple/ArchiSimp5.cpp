...
float P_vitEmissionPrim=0.5; /* Vitesse d'émission des primaires (en jour-1) */
...
/* Calcul du nouveau nombre de racines tardives */
  ...
  nouvNbTard=int (P_vitEmissionPrim*(temps-P_ageEmissionTard));
